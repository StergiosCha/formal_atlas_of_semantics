...
| Witness comparison contract | Independent packages can be rejoined without changing them exactly when their witnesses align. Two admissible models agree on atomic inhabitation but disagree on meet inhabitation. Model transport needs explicit compatibility conditions. | [Coq contract](atlas/ttr/Witness_Contract.v), [scope and source notes](atlas_data/audits/witness_contract_2026_09_25.md) |
